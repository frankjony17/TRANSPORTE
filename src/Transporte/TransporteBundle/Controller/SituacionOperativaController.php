...
class SituacionOperativaController extends Controller
{
     ...
     * @Route("list")
     */
    public function listAction(Request $rq) //Request $rq ,va dentro de los parentisis
    {
         $em = $this->getDoctrine()->getManager();

//        $data = $this->get('otros.util')->toArray($this->getDoctrine()->getManager()->getRepository('TransporteBundle:SituacionOperativa')->findAll());
//
