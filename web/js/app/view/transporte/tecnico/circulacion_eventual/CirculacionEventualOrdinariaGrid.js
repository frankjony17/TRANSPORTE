...
Ext.define('CDT.view.transporte.tecnico.circulacion_eventual.CirculacionEventualOrdinariaGrid', {
    extend : 'Ext.grid.Panel',
    xtype  : 'circulacioneventualordinariaGrid',
    ...
    initComponent: function () {
        ...
        me.myData = [];
        // Store
        me.store = Ext.create('CDT.store.transporte.tecnico.CirculacionEventualOrdinariaStore');
        // Modelo de columna
        me.columns = [{
            xtype : 'rownumberer',
            text  : 'No',
