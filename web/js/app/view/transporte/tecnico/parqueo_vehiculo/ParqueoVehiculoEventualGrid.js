...
Ext.define('CDT.view.transporte.tecnico.parqueo_vehiculo.ParqueoVehiculoEventualGrid', {
    extend : 'Ext.grid.Panel',
    xtype  : 'parqueovehiculoeventualGrid',
    ...
    initComponent: function () {
        ...
        me.myData = [];
        // Store
        me.store = Ext.create('CDT.store.transporte.tecnico.ParqueoVehiculoEventualStore');
        // Modelo de columna
        me.columns = [{
            xtype : 'rownumberer',
            text  : 'No',
