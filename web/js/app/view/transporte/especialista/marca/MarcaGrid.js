...
Ext.define('CDT.view.transporte.especialista.marca.MarcaGrid', {
    ...
    initComponent: function()
    {
        ...
        // Store 
        me.store = Ext.create('CDT.store.transporte.especialista.MarcaStore');
        // Modelo de columna      
        me.columns = [
            {
                xtype : 'rownumberer',
