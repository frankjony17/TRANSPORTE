                ...
                items: [{
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            name: 'marca',
                            emptyText: 'Marca',
                            store: Ext.create('CDT.store.transporte.especialista.MarcaStore'),
                            queryMode: 'local',
                            displayField: 'nombre',
                            valueField: 'id',
                            margin: '0 5 0 0',
                            ...
                            name: 'modelo',
                            emptyText: 'Modelo',
                            store: Ext.create('CDT.store.transporte.especialista.ModeloStore'),
                            queryMode: 'local',
                            displayField: 'nombre',
                            valueField: 'id',
                            margin: '0 5 0 0',
                            ...
                            name: 'vehiculoTipo',
                            emptyText: 'Tipo',
                            store: Ext.create('CDT.store.transporte.especialista.VehiculoTipoStore'),
                            queryMode: 'local',
                            displayField: 'nombre',
                            valueField: 'id',
                            margin: '0 5 0 0',
