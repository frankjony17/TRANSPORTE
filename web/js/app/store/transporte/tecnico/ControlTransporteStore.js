...
Ext.define('CDT.store.transporte.tecnico.ControlTransporteStore', {
    ...
    fields: ['chapa', 'chofer', 'area_parqueo', 'area', 'unidad_organizativa', 'hora_entrada', 'hora_salida', 'autorizado', 'observaciones', 'fecha', 'matricula_id', 'control_transporte_id', 'chofer_vehiculo_id'],
    autoLoad: true,
