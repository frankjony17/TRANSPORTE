...
Ext.define('CDT.controller.transporte.especialista.MarcaController', {
    extend: 'Ext.app.Controller',

    views: [
        'transporte.especialista.marca.MarcaGrid',
        'transporte.especialista.marca.MarcaForm'
    ],
    ...
    init: function()
    {
        ...
        me.control({
            ...
            'marcaGrid button[iconCls=fa fa-plus]': {
                click: me.showMarca
            },
            'marcaGrid button[iconCls=fa fa-times]': {
            ...
            // Formulario
            'marcaForm button[iconCls=fa fa-check-circle-o]': {
                click: me.validateForm
            }
        });
    },
    loadStore: function () { var me = this; me.store.load(); },
    // Mostrar Windows Marca.
    showMarca: function()
    {
        Ext.create('CDT.view.transporte.especialista.marca.MarcaForm');
    },
    ...
    validateForm : function ()
    {
        ...
        if (me.form.getForm().isValid()) {
            me.addMarca(me.form.getForm().getValues(), me.form.getForm());
        } else {
    ...
    // Insertar datos de la marca.
    addMarca: function (record, form)
    {
        var me = this;
        Ext.Ajax.request({
            url: entorno+'/transporte/marca/add',
            params: {
            ...
            success: function (response) {
                switch (response.responseText) {
                    case '':
                        ...
                        break;
                    case 'Unico':
                        Ext.ex.MessageBox('Atención', 'Ya existe la Marca: <b>'+record['Nombre']+'</b>', 'question');
                        form.reset();
                        break;
                    default:
    ...
    edit: function (editor, context, eOpts)
    {
        var me = this;
        Ext.Ajax.request({
            url: entorno+'/transporte/marca/edit',
            params: {
            ...
            success: function(response){
                switch(response.responseText){
                    case '':
                        ...
                        break;
                    case 'Unico':
                        Ext.ex.MessageBox('Atención', 'Ya existe la Marca: <b>'+context.record.get('nombre')+'</b>', 'question');
                        me.loadStore();
                        break;
                    default:
                        Ext.ex.MessageBox('Error', response.responseText, 'error');
    ...
    remove: function (btn)
    {
        if (btn === 'yes')
        {
            ...
            Ext.Ajax.request({
                url: entorno+'/transporte/marca/remove',
                params: {
                    ids:  Ext.encode(ids)
                },
                success: function(response){
