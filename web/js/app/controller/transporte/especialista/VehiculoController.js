...
Ext.define('CDT.controller.transporte.especialista.VehiculoController', {
    ...
    control: {
            ...
            'vehiculoGrid button[iconCls=fa fa-plus]': {
                click: "showVehiculo"
            },
            'vehiculoGrid button[iconCls=fa fa-times]': {
               click: "confirmRemuve"
            },
    ...
    {   
        ...
        {  //Obtener registro seleccionado del grid.
            var record = me.grid.selModel.getSelection()[0],
                ...
                config = { title: 'Editar vehículo', btnText: 'Editar', btnIconCls: 'fa fa-pencil', btnAction: 'edit', vehiculoId: record.get('id') },
                // Crear Window.
                win = Ext.create('CDT.view.transporte.especialista.vehiculo.VehiculoForm',config),
    ...
    addVehiculo: function (record, form)
    {
        ...
        Ext.Ajax.request({
            ...
            params: {
                ...
                VehiculoTipo         : record['vehiculoTipo']
            },
